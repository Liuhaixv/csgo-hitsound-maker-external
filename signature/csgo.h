...
namespace offsets
{
	...
	constexpr ptrdiff_t dwForceJump = 0x52858DC;
	...
	constexpr ptrdiff_t dwGameRulesProxy = 0x52F910C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDE9C9C;
	constexpr ptrdiff_t dwGlobalVars = 0x58CCE0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x53245E8;
	...
	constexpr ptrdiff_t is_c4_owner = 0x3CB3D0;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3BE35A;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x33135A80;
